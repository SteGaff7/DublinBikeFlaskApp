...
def get_chart_data(station_number):
    ...
    '''
    csv = "/Users/patsylowe/Desktop/ComputerScienceS2/SoftwareEngineering/Project/VillageBikes/Project/model/graph_csvs/"+str(station_number)+".csv"
...
def predictive(details):
    ...
    file = open("/Users/patsylowe/Desktop/ComputerScienceS2/SoftwareEngineering/Project/VillageBikes/Project/model/pickles/"+str(station_number)+"_"+str(weekday)+".sav", "rb")
